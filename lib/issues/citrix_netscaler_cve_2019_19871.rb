  ...
  def self.metadata
    {
      ...
      references: [
        { type: "vulnerability", uri: "https://nvd.nist.gov/vuln/detail/CVE-2019-19781" },
        { type: "vulnerability", uri: "https://www.tripwire.com/state-of-security/vert/citrix-netscaler-cve-2019-19781-what-you-need-to-know/" },
        ...
        { type: "remediation", uri: "https://support.citrix.com/article/CTX267027" },
        { type: "exploit", uri: "https://www.trustedsec.com/blog/critical-exposure-in-citrix-adc-netscaler-unauthenticated-remote-code-execution/" },
        ...
        { type: "intelligence", uri: "https://isc.sans.edu/forums/diary/Citrix+ADC+Exploits+are+Public+and+Heavily+Used+Attempts+to+Install+Backdoor/25700/" },
        { type: "intelligence", uri: "https://www.trustedsec.com/blog/netscaler-remote-code-execution-forensics" },
      ]
    }
  end
