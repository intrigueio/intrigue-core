module Intrigue
  ...
  class VulnExchangeCve202016875 < BaseIssue
    ...
    def self.generate(instance_details={})
      {
        added: "2020-09-11",
        name: "microsoft_exchange_cve_2020_16875",
        pretty_name: "Microsoft Exchange Server DlpUtils AddTenantDlpPolicy Remote Code Execution Vulnerability (CVE-2020-16875)",
        identifiers: [
