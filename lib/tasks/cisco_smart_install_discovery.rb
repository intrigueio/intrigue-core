module Intrigue
module Task
class CiscoSmartInstallDiscovery < BaseTask

  def self.metadata
    {
      :name => "cisco_smart_install_disovery",
      :pretty_name => "Cisco Smart Install Discovery",
      :authors => ["jcran"],
      :identifiers => [{ "cve" =>  false }],
      :description => "Check for Cisco Smart Install",
      :references => [
