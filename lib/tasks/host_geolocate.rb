...
class GeolocateHostTask < BaseTask
  ...
  def run
    ...
    begin
      @task_result.log "looking up location for #{ip_address}"
      ...
      if loc
        @task_result.log "adding location for #{ip_address}"
        ...
        @task_result.log "Argument Error #{e}"
      rescue Encoding::InvalidByteSequenceError => e
        @task_result.log "Encoding error: #{e}"
