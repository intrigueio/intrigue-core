...
class UriBruteFocusedContent < BaseTask
  ...
  def run
    ...
    spring_boot_list =[
      { issue_type: "spring_info_leak", path: "/auditevents", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/autoconfig", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/beans", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/caches", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/conditions", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/configprops", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/dump", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/env", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/flyway", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/health", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/heapdump", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/httptrace", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/info", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/integrationgraph", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/jolokia", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/logfile", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/loggers", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/liquidbase", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/metrics", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/mappings", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/prometheus", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/scheduledtasks", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/sessions", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/shutdown", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/threaddump", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "/trace", severity: 4, body_regex: nil, status: "potential" },
      # add /actuator infront of all
      { issue_type: "spring_info_leak", path: "actuator/auditevents", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/autoconfig", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/beans", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/caches", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/conditions", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/configprops", severity: 4, body_regex: nil, status: "potential" },
      ...
      { issue_type: "spring_info_leak", path: "actuator/heapdump", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/httptrace", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/info", severity: 4, body_regex: nil, status: "potential" },
      ...
      { issue_type: "spring_info_leak", path: "actuator/logfile", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/loggers", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/liquidbase", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/metrics", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/mappings", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/prometheus", severity: 4, body_regex: nil, status: "potential" },
      { issue_type: "spring_info_leak", path: "actuator/scheduledtasks", severity: 4, body_regex: nil, status: "potential" },
      ...
      { issue_type: "spring_info_leak", path: "actuator/threaddump", severity: 4, body_regex: nil, status: "potential" },
