...
module Intrigue
    ...
    module Issue
      class MicrosoftExchangeCve202134473 < BaseIssue
        def self.generate(instance_details={})
        {
          added: "2021-08-09",
          name: "microsoft_exchange_cve_2021_34473",
          pretty_name: "Microsoft Exchange Server Remote Code Execution (CVE-2021-34473)",
          identifiers: [
            { type: "CVE", name: "CVE-2021-34473" }
          ],
          severity: 1,
          status: "potential",
          ...
          references: [
            { type: "description", uri: "https://msrc.microsoft.com/update-guide/vulnerability/CVE-2021-34473" },
            { type: "description", uri: "https://nvd.nist.gov/vuln/detail/CVE-2021-34473"}
          ],
    ...
    module Task
      class MicrosoftExchangeCve202134473 < BaseCheck
