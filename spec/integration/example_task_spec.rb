...
=> {"id"=>"d8e5fb80-4220-4b24-99e9-a5f814733390",
 ...
 "entity_ids"=>
  [{"id"=>"7c85fa0c-01bc-4875-b8eb-91e09198cf76", "type"=>"IpAddress", "attributes"=>{"name"=>"47.132.122.212"}},
   ...
   {"id"=>"84917f2e-dcea-45be-9e33-31ad565ad0a7", "type"=>"IpAddress", "attributes"=>{"name"=>"249.57.82.141"}},
   {"id"=>"1394cf6f-51a5-4816-ad60-083760c9ff5d", "type"=>"IpAddress", "attributes"=>{"name"=>"115.202.180.248"}},
   {"id"=>"429a238b-acbc-4b92-a3bd-7df65ba4ab1f", "type"=>"IpAddress", "attributes"=>{"name"=>"210.129.143.208"}},
   {"id"=>"f95a8883-553d-4559-9725-4f5ca0a11a88", "type"=>"IpAddress", "attributes"=>{"name"=>"114.141.10.89"}},
   {"id"=>"be0a62a5-724a-4243-8b13-9ae16f248a9b", "type"=>"IpAddress", "attributes"=>{"name"=>"95.225.6.43"}},
   {"id"=>"bce4aa6d-767c-4ce8-b9ff-5de6e6ee8fc3", "type"=>"IpAddress", "attributes"=>{"name"=>"24.239.45.143"}},
   {"id"=>"f50ce7a8-5a9d-482d-858e-d548b83abfdd", "type"=>"IpAddress", "attributes"=>{"name"=>"41.89.35.5"}},
   {"id"=>"98e75991-3e7f-4275-8004-6fefd4e2a4ea", "type"=>"IpAddress", "attributes"=>{"name"=>"214.103.174.118"}}]}
...
=end
      ...
      expect(result["entity_id"]["attributes"]["name"]).to match "test.com"
